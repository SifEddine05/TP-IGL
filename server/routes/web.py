...
def get_annonces():
    ...
    for annonce in annonce_elements:
        ...
        for annonce in annonces:
            ...
            cursor.execute(
                "INSERT INTO user (public_id, nom, prenom, email,phone_number,address, is_admin) VALUES (%s, %s, %s, %s, %s, %s, %s)", (str(uuid.uuid4()), nom, prenom, email, phone, user_address, False,))
            conn.commit()
