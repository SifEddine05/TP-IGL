...
const NotFound = () => {
    return ( 
    <section className="flex items-center h-screen w-full lg:p-16 md:p-14 sm:p-12 p-10 bg-[#FF5D02] text-black">
	<div className="container flex flex-col items-center justify-center lg:px-5 md:px-4 sm:px-3 px-2 text-black mx-auto lg:my-8 md:my-6 sm:my-4 my-2">
		<div className="max-w-md text-center">
			...
			<Link  to="/" className="px-8 py-3 font-semibold rounded text-white bg-black text-[#FFFF] hover:text-[#ff5d02]">Back to homepage</Link>
		</div>
	</div>
</section> );
}
