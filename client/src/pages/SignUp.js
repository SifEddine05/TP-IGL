    ...
    const [show2 , setShow2]=useState(false)
        ...
        <div className="  w-full flex justify-between">
            ...
            <div className=" self-center   justify-center items-center lg:w-[60%] sm:w-[75%] w-[90%]">
                ...
                <div className="flex justify-center sm:py-3 py-2 w-full">
                 ...
                 <div className="flex justify-center sm:py-3 py-2 w-full">
                     <div className="w-[45%] relative">
                        <input  type={type} className=" lg:text-[16px] md:text-[14px] sm:text-[11px] text-[9px] border-gray-600 focus:outline-none w-full border-2  focus:border-[#FFC29F] rounded-full  p-2 px-3"placeholder="Password"  />
                      {!show  && 
                 ...
                 <div className="flex justify-center  sm:py-3 py-2 w-full">
                     <div className="w-[45%] relative">
                        <input  type={type2} className=" lg:text-[16px] md:text-[14px] sm:text-[11px] text-[9px] border-gray-600 focus:outline-none w-full border-2  focus:border-[#FFC29F] rounded-full  p-2  px-3"placeholder="Confirm Password"  />
                      {!show2  && 
                ...
                <div className="w-[45%] mx-auto rounded-full  bg-[#FF5D02]   p-2 hover:text-[#fff] hover:cursor-pointer hover:bg-gray-600 ">
                    <h3 className="text-center lg:text-[18px] md:text-[15px] sm:text-[12px] text-[10px] font-bold">Sign Up</h3>
                </div>
                ...
                <div className="w-[50%] mx-auto lg:py-7 md:py-5 sm:pt-3 pt-2">
                    <p className="text-center lg:text-[16px] md:text-[14px] sm:text-[11px] text-[9px] ">Already have an account ? <a href="/signup" className="underline hover:text-[#177aeb]">Sign in</a></p>
                </div>
            </div>
