  ...
  .catch((err)=>{
    ...
    return ( 
       <div className='bg-white h-full'>
            ...
            <div className='lg:mt-4 md:mt-3 sm:mt-2 mt-1 mx-auto flex justify-around flex-wrap items-center w-[100%] gap-2'>
            {err && <div  className="w-[100%] mx-auto lg:pt-2 pt-1" >
                ...
                {MyListing.map((e)=>{
                   ...
                   <div className="flex flex-col justify-center items-center w-[30%] lg:w-[18%] " >
