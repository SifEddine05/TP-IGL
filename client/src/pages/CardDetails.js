...
//      //           //      images: ['http://res.cloudinary.com/dc3fxvt26/image/upload/v1675532293/hagkkonym1bh0c4jj557.png']
//      //           // })
...
//                                    <div onClick={()=>{localStorage.setItem('id_announce',cardId)}} className="w-full ml-[20%]  "><Link to="/sendMsg" className="text-black lg:text-xl md:text-lg sm:text-md text-xs bg-[#FF5D02] hover:bg-gray-600  hover:text-white rounded-full pt-[5%] pb-[5%] pl-[10%] pr-[10%]">Buy this appartment</Link></div>
//                               </div>
...
//                                    </button></a>
//                                    <div onClick={()=>{localStorage.setItem('id_announce',cardId)}} className="w-[50%]  "><Link to='/sendMsg' className=" flex items-center  md:p-3 p-2  rounded-full border-2 border-black hover:bg-black hover:bg-opacity-10">
...
const CardDetails = () => {
     ...
     useEffect(() => {
          ...
          const fetchingData = async () => {
               ...
               setPhone(data2.phone_number)
               setFullName(`${data2.prenom} ${data2.nom} `)
               //  setCard({ ...Card, userName: `${data2.prenom} ` })
               console.log(data2);
          }
     ...
     return (
          <div>
               ...
               <div className="pl-[5%] pr-[5%] pt-[2%] pb-[2%] ">
                    ...
                    <div className="lg:text-lg md:text-md sm:text-sm text-xs">{fullName}</div>
               ...
               <div className="modal" id="my-modal-2">
                    <div className="modal-box">
                         <h3 className="font-bold text-lg">Would you Call the owner ! </h3>
                         <p className="py-4">This is his phone number : {phone} </p>
                         <div className="modal-action">
                              <a href="#" className="btn"> OK! </a>
                         </div>
                    </div>
