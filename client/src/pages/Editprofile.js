            ...
            <div className="w-[80%] rounded-lg border-2 lg:mt-10 md:mt-8 sm:mt-6 mt-4 mx-auto shadow-md lg:mb-10 md:mb-8 sm:mb-6 mb-4">
                <div className="w-[90%] mx-auto flex justify-between  items-center">
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        ...
                        <input value={firstName} onChange={(e)=>setFirstName(e.target.value)} type="text" id="firstname" name="firstname" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        <label for="lastname" className="lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] pb-2">Last name</label>
                        <input value={lastName} onChange={(e)=>setLastName(e.target.value)} type="text" id="lastname" name="lastname" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                </div>
                <div className="w-[90%] mx-auto flex justify-between  items-center">
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        <label for="email" className="lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px]  pb-2">Email</label>
                        <input value={email} onChange={(e)=>setEmail(e.target.value)} type="email" id="email" name="email" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        <label for="phone" className="lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] pb-2">Phone Number</label>
                        <input value={phone} onChange={(e)=>setPhone(e.target.value)} type="tel" maxLength="10" id="phone" name="phone" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                </div>
                <div className="w-[90%] mx-auto flex flex-col  justify-center  items-start lg:mt-10 md:mt-8 sm:mt-6 mt-4 ">
                    ...
                    <input value={adress} onChange={(e)=>setAdress(e.target.value)} type="text" id="Address" name="Address" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                </div>
                <div className="w-[90%] mx-auto flex justify-between  items-center">
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        <label for="password" className="lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px]  pb-2">Password</label>
                        <input value={password} onChange={(e)=>setPassword(e.target.value)} type="password" id="password" name="password" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                    <div className="lg:mt-10 md:mt-8 sm:mt-6 mt-4   w-[40%]">
                        <label for="newpassword" className="lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] pb-2">New Password</label>
                        <input value={newPassword} onChange={(e)=>setNewPassword(e.target.value)} type="password"  id="newpassword" name="newpassword" className="bg-white lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px] w-[100%]  p-2 px-4 rounded-full border-2 border-black"/>
                    </div>
                </div>
