    ...
    return (  
        <div className="">
            ...
            <div>
                ...
                <input type="text" id="prenom" name="prenom" className="w-[100%] mt-[1%] pt-[0.5%] pb-[0.5%] pl-[20%] rounded-full border-2 "/>
            </div>
            ...
            <div className="w-full flex justify-between mt-[2%] mr-[3%]">
                <div>
                    ...
                    <input type="text" id="email" name="email" className="w-full mt-[1%] pt-[4%] pb-[0.5%]  rounded-full border-2 "/>
                </div>
                <div>
                      
                      <label for="phone" className="text-sm text-[#767676]">Phone mobile</label>
                      <input type="text" name="phone" className=" w-full mt-[1%] pt-[3%] pb-[0.5%]  rounded-full border-2 "/>
                </div>
            </div>
            ...
            <div className="mt-[1%]">
              ...
              <input type="text" id="address" name="address" className="w-full mt-[1%] pt-[0.5%] pb-[0.5%] pl-[20%] rounded-full border-2 "/>
          </div>
          <div className="w-full flex justify-between mt-[2%] mr-[3%]">
                <div>
